...
| ------------ | ------------- | ------------- | ------------- |
| **pkiEmployeeID** | **kotlin.Int** | The unique ID of the Employee. |  |
| **fkiDepartmentID** | **kotlin.Int** | The unique ID of the Department |  |
| **sEmployeeCode** | **kotlin.String** | The code of the Employee |  |
| **sEmployeeInternalcode** | **kotlin.String** | The internalcode of the Employee |  |
| **bEmployeeIsactive** | **kotlin.Boolean** | Whether the employee is active or not |  |
| **dtEmployeeHiredate** | **kotlin.String** | The hiredate of the Employee |  [optional] |
| **dtEmployeeLeavedate** | **kotlin.String** | The leavedate of the Employee |  [optional] |
