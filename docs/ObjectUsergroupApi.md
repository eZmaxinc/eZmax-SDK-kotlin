...
> CommonMinusGetAutocompleteMinusV1MinusResponse usergroupGetAutocompleteV1(sSelector, sQuery, acceptLanguage)
...
try {
    val result : CommonMinusGetAutocompleteMinusV1MinusResponse = apiInstance.usergroupGetAutocompleteV1(sSelector, sQuery, acceptLanguage)
    println(result)
