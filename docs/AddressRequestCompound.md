...
| ------------ | ------------- | ------------- | ------------- |
| **fkiAddresstypeID** | **kotlin.Int** | The unique ID of the Addresstype.  Valid values:  |Value|Description| |-|-| |1|Office| |2|Home| |3|Real Estate Invoice| |4|Invoicing| |5|Shipping| |  |
