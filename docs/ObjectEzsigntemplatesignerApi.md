...
> EzsigntemplatesignerMinusGetObjectMinusV1MinusResponse ezsigntemplatesignerGetObjectV1(pkiEzsigntemplatesignerID)
...
val pkiEzsigntemplatesignerID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsigntemplatesignerMinusGetObjectMinusV1MinusResponse = apiInstance.ezsigntemplatesignerGetObjectV1(pkiEzsigntemplatesignerID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsigntemplatesignerApi#ezsigntemplatesignerGetObjectV1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsigntemplatesignerApi#ezsigntemplatesignerGetObjectV1")
    e.printStackTrace()
}
```
