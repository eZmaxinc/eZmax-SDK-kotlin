...
try {
    ...
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderCreateObjectV3")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderCreateObjectV3")
    e.printStackTrace()
}
```
...
val apiInstance = ObjectEzsignfolderApi()
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
val ezsignfolderDuplicateV1Request : EzsignfolderDuplicateV1Request =  // EzsignfolderDuplicateV1Request | 
try {
    val result : EzsignfolderDuplicateV1Response = apiInstance.ezsignfolderDuplicateV1(pkiEzsignfolderID, ezsignfolderDuplicateV1Request)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderDuplicateV1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderDuplicateV1")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderEditObjectV3")
    e.printStackTrace()
}
```
...
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsignfolderGetActionableElementsV2Response = apiInstance.ezsignfolderGetActionableElementsV2(pkiEzsignfolderID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetActionableElementsV2")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetActionableElementsV2")
    e.printStackTrace()
}
```
...
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsignfolderGetActionableElementsV3Response = apiInstance.ezsignfolderGetActionableElementsV3(pkiEzsignfolderID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetActionableElementsV3")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetActionableElementsV3")
    e.printStackTrace()
}
```
...
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsignfolderGetEzsignannotationsV1Response = apiInstance.ezsignfolderGetEzsignannotationsV1(pkiEzsignfolderID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignannotationsV1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignannotationsV1")
    e.printStackTrace()
}
```
...
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsignfolderGetEzsigndocumentsV2Response = apiInstance.ezsignfolderGetEzsigndocumentsV2(pkiEzsignfolderID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsigndocumentsV2")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsigndocumentsV2")
    e.printStackTrace()
}
```
...
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsignfolderGetEzsignfoldersignerassociationsV2Response = apiInstance.ezsignfolderGetEzsignfoldersignerassociationsV2(pkiEzsignfolderID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignfoldersignerassociationsV2")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignfoldersignerassociationsV2")
    e.printStackTrace()
}
```
...
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsignfolderGetEzsignformfieldgroupsV1Response = apiInstance.ezsignfolderGetEzsignformfieldgroupsV1(pkiEzsignfolderID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignformfieldgroupsV1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignformfieldgroupsV1")
    e.printStackTrace()
}
```
...
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
try {
    val result : EzsignfolderGetEzsignsignaturesV1Response = apiInstance.ezsignfolderGetEzsignsignaturesV1(pkiEzsignfolderID)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignsignaturesV1")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetEzsignsignaturesV1")
    e.printStackTrace()
}
```
...
try {
    ...
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderGetObjectV3")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderGetObjectV3")
    e.printStackTrace()
}
```
...
val apiInstance = ObjectEzsignfolderApi()
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
val ezsignfolderImportEzsigntemplatepackageV2Request : EzsignfolderImportEzsigntemplatepackageV2Request =  // EzsignfolderImportEzsigntemplatepackageV2Request | 
try {
    val result : EzsignfolderImportEzsigntemplatepackageV2Response = apiInstance.ezsignfolderImportEzsigntemplatepackageV2(pkiEzsignfolderID, ezsignfolderImportEzsigntemplatepackageV2Request)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderImportEzsigntemplatepackageV2")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderImportEzsigntemplatepackageV2")
    e.printStackTrace()
}
```
...
val apiInstance = ObjectEzsignfolderApi()
val pkiEzsignfolderID : kotlin.Int = 56 // kotlin.Int | 
val ezsignfolderImportEzsigntemplatepackageV3Request : EzsignfolderImportEzsigntemplatepackageV3Request =  // EzsignfolderImportEzsigntemplatepackageV3Request | 
try {
    val result : EzsignfolderImportEzsigntemplatepackageV3Response = apiInstance.ezsignfolderImportEzsigntemplatepackageV3(pkiEzsignfolderID, ezsignfolderImportEzsigntemplatepackageV3Request)
    println(result)
} catch (e: ClientException) {
    println("4xx response calling ObjectEzsignfolderApi#ezsignfolderImportEzsigntemplatepackageV3")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderImportEzsigntemplatepackageV3")
    e.printStackTrace()
}
```
...
try {
    ...
    println("5xx response calling ObjectEzsignfolderApi#ezsignfolderReorderV2")
    e.printStackTrace()
}
```
