...
class EzsignsigningreasonResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignsigningreasonResponse
        //val modelInstance = EzsignsigningreasonResponse()
