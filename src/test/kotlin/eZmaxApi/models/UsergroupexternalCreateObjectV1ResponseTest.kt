...
class UsergroupexternalCreateObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UsergroupexternalCreateObjectV1Response
        //val modelInstance = UsergroupexternalCreateObjectV1Response()
