...
class BrandingEditObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of BrandingEditObjectV1Response
        //val modelInstance = BrandingEditObjectV1Response()
