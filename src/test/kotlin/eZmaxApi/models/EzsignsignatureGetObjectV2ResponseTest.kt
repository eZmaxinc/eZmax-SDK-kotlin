...
class EzsignsignatureGetObjectV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignsignatureGetObjectV2Response
        //val modelInstance = EzsignsignatureGetObjectV2Response()
