...
class EzsignfoldertypeCreateObjectV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignfoldertypeCreateObjectV2Response
        //val modelInstance = EzsignfoldertypeCreateObjectV2Response()
