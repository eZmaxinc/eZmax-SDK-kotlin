...
class UsergroupAutocompleteElementResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UsergroupAutocompleteElementResponse
        //val modelInstance = UsergroupAutocompleteElementResponse()
        ...
        // to test the property `bUsergroupIsactive` - Whether the Usergroup is active or not
        should("test bUsergroupIsactive") {
            // uncomment below to test the property
            //modelInstance.bUsergroupIsactive shouldBe ("TODO")
        }
