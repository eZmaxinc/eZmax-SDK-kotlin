...
class EzsignsignaturecustomdateRequestV2Test : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignsignaturecustomdateRequestV2
        //val modelInstance = EzsignsignaturecustomdateRequestV2()
