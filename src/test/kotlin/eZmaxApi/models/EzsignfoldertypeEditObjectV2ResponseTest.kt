...
class EzsignfoldertypeEditObjectV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignfoldertypeEditObjectV2Response
        //val modelInstance = EzsignfoldertypeEditObjectV2Response()
