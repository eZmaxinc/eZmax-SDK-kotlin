...
class SignatureDeleteObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SignatureDeleteObjectV1Response
        //val modelInstance = SignatureDeleteObjectV1Response()
