...
class EzsigntemplatepackageRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsigntemplatepackageRequest
        //val modelInstance = EzsigntemplatepackageRequest()
