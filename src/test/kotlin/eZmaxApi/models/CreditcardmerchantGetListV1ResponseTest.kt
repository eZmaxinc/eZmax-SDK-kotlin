...
class CreditcardmerchantGetListV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreditcardmerchantGetListV1Response
        //val modelInstance = CreditcardmerchantGetListV1Response()
