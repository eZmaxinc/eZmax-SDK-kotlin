...
class UsergroupexternalmembershipResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UsergroupexternalmembershipResponse
        //val modelInstance = UsergroupexternalmembershipResponse()
