...
class EzsignfoldertypeEditObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignfoldertypeEditObjectV1Response
        //val modelInstance = EzsignfoldertypeEditObjectV1Response()
