...
class PermissionEditObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PermissionEditObjectV1Response
        //val modelInstance = PermissionEditObjectV1Response()
