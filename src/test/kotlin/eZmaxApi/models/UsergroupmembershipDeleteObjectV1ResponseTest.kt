...
class UsergroupmembershipDeleteObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UsergroupmembershipDeleteObjectV1Response
        //val modelInstance = UsergroupmembershipDeleteObjectV1Response()
