...
class EzsignpageConsultV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignpageConsultV1Response
        //val modelInstance = EzsignpageConsultV1Response()
