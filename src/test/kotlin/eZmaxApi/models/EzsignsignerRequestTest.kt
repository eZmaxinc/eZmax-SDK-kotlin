...
class EzsignsignerRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignsignerRequest
        //val modelInstance = EzsignsignerRequest()
        ...
        // to test the property `eEzsignsignerLogintype` - The method the Ezsignsigner will authenticate to the signing platform.  1. **Password** means the Ezsignsigner will receive a secure link by email. 2. **PasswordPhone** means the Ezsignsigner will receive a secure link by email and will need to authenticate using SMS or Phone call. **Additional fee applies**. 3. **PasswordQuestion** means the Ezsignsigner will receive a secure link by email and will need to authenticate using a predefined question and answer. 4. **InPersonPhone** means the Ezsignsigner will only be able to sign \"In-Person\" and will need to authenticate using SMS or Phone call. No email will be sent for invitation to sign. **Additional fee applies**. 5. **InPerson** means the Ezsignsigner will only be able to sign \"In-Person\" and there won't be any authentication. No email will be sent for invitation to sign. Make sure you evaluate the risk of signature denial and at minimum, we recommend you use a handwritten signature type.
        should("test eEzsignsignerLogintype") {
            // uncomment below to test the property
            //modelInstance.eEzsignsignerLogintype shouldBe ("TODO")
        }

        // to test the property `sEzsignsignerSecretanswer` - The predefined answer to the secret question the Ezsignsigner will need to provide to successfully authenticate.
        should("test sEzsignsignerSecretanswer") {
            // uncomment below to test the property
            //modelInstance.sEzsignsignerSecretanswer shouldBe ("TODO")
        }
