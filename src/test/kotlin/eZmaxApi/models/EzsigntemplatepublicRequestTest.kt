...
class EzsigntemplatepublicRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsigntemplatepublicRequest
        //val modelInstance = EzsigntemplatepublicRequest()
