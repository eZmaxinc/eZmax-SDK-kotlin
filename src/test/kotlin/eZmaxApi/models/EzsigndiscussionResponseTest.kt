...
class EzsigndiscussionResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsigndiscussionResponse
        //val modelInstance = EzsigndiscussionResponse()
