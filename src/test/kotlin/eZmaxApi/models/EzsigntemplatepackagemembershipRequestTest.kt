...
class EzsigntemplatepackagemembershipRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsigntemplatepackagemembershipRequest
        //val modelInstance = EzsigntemplatepackagemembershipRequest()
