...
class EzsignfolderEditObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignfolderEditObjectV1Response
        //val modelInstance = EzsignfolderEditObjectV1Response()
