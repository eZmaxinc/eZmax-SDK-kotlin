...
class ApikeyCreateObjectV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ApikeyCreateObjectV2Response
        //val modelInstance = ApikeyCreateObjectV2Response()
