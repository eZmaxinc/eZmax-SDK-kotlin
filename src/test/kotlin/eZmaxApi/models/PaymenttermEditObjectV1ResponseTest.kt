...
class PaymenttermEditObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PaymenttermEditObjectV1Response
        //val modelInstance = PaymenttermEditObjectV1Response()
