...
class EzsigntemplatepublicListElementTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsigntemplatepublicListElement
        //val modelInstance = EzsigntemplatepublicListElement()
        ...
        // to test the property `iEzsignfolder` - The total number of Ezsignfolders using the Ezsigntemplatepublic
        should("test iEzsignfolder") {
            // uncomment below to test the property
            //modelInstance.iEzsignfolder shouldBe ("TODO")
        }

        // to test the property `iEzsigndocument` - The total number of Ezsigndocuments using the Ezsigntemplatepublic
