...
class EzsignfoldertypeResponseCompoundV3Test : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignfoldertypeResponseCompoundV3
        //val modelInstance = EzsignfoldertypeResponseCompoundV3()
