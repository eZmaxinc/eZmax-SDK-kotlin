...
class CreditcardclientCreateObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreditcardclientCreateObjectV1Response
        //val modelInstance = CreditcardclientCreateObjectV1Response()
