...
class BrandingCreateObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of BrandingCreateObjectV1Response
        //val modelInstance = BrandingCreateObjectV1Response()
