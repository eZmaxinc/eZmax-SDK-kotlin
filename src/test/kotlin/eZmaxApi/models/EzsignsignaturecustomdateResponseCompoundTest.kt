...
class EzsignsignaturecustomdateResponseCompoundTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignsignaturecustomdateResponseCompound
        //val modelInstance = EzsignsignaturecustomdateResponseCompound()
        ...
        // to test the property `iEzsignsignaturecustomdateX` - The X coordinate (Horizontal) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 2 inches from the left border of the page, you would use \"200\" for the X coordinate.
        should("test iEzsignsignaturecustomdateX") {
            // uncomment below to test the property
            //modelInstance.iEzsignsignaturecustomdateX shouldBe ("TODO")
        }

        // to test the property `iEzsignsignaturecustomdateY` - The Y coordinate (Vertical) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 3 inches from the top border of the page, you would use \"300\" for the Y coordinate.
        should("test iEzsignsignaturecustomdateY") {
            // uncomment below to test the property
            //modelInstance.iEzsignsignaturecustomdateY shouldBe ("TODO")
        }
