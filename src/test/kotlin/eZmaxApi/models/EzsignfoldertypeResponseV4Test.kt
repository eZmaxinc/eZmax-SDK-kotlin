...
class EzsignfoldertypeResponseV4Test : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignfoldertypeResponseV4
        //val modelInstance = EzsignfoldertypeResponseV4()
