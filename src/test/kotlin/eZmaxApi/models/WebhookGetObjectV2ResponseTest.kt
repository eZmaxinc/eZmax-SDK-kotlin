...
class WebhookGetObjectV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of WebhookGetObjectV2Response
        //val modelInstance = WebhookGetObjectV2Response()
