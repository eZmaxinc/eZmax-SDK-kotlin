...
class SessionhistoryGetListV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of SessionhistoryGetListV1Response
        //val modelInstance = SessionhistoryGetListV1Response()
