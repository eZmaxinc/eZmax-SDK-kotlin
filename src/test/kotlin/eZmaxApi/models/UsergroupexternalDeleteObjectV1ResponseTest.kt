...
class UsergroupexternalDeleteObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UsergroupexternalDeleteObjectV1Response
        //val modelInstance = UsergroupexternalDeleteObjectV1Response()
