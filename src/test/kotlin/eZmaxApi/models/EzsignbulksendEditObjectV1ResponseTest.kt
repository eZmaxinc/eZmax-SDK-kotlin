...
class EzsignbulksendEditObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignbulksendEditObjectV1Response
        //val modelInstance = EzsignbulksendEditObjectV1Response()
