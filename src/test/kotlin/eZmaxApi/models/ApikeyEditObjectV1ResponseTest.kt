...
class ApikeyEditObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ApikeyEditObjectV1Response
        //val modelInstance = ApikeyEditObjectV1Response()
