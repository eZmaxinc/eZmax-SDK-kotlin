...
class UserstagedGetListV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UserstagedGetListV1Response
        //val modelInstance = UserstagedGetListV1Response()
