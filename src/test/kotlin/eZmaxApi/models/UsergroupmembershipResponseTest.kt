...
class UsergroupmembershipResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UsergroupmembershipResponse
        //val modelInstance = UsergroupmembershipResponse()
