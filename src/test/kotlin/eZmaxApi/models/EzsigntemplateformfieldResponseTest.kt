...
class EzsigntemplateformfieldResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsigntemplateformfieldResponse
        //val modelInstance = EzsigntemplateformfieldResponse()
