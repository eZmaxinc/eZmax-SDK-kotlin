...
class ContacttitleGetAutocompleteV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ContacttitleGetAutocompleteV2Response
        //val modelInstance = ContacttitleGetAutocompleteV2Response()
