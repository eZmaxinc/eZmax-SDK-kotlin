...
class EzsignuserGetObjectV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignuserGetObjectV2Response
        //val modelInstance = EzsignuserGetObjectV2Response()
