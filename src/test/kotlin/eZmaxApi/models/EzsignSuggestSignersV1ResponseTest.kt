...
class EzsignSuggestSignersV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignSuggestSignersV1Response
        //val modelInstance = EzsignSuggestSignersV1Response()
