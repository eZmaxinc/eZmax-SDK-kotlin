...
class DiscussionmessageResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of DiscussionmessageResponse
        //val modelInstance = DiscussionmessageResponse()
