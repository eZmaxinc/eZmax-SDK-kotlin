...
class EzsignfoldertypeResponseCompoundV4Test : ShouldSpec() {
    init {
        ...
        // to test the property `aObjUsergroupAll`
        should("test aObjUsergroupAll") {
            // uncomment below to test the property
            //modelInstance.aObjUsergroupAll shouldBe ("TODO")
        }

        // to test the property `aObjUsergroupRestricted`
        should("test aObjUsergroupRestricted") {
            // uncomment below to test the property
            //modelInstance.aObjUsergroupRestricted shouldBe ("TODO")
        }

        // to test the property `aObjUsergroupTemplate`
        should("test aObjUsergroupTemplate") {
            // uncomment below to test the property
            //modelInstance.aObjUsergroupTemplate shouldBe ("TODO")
        }
