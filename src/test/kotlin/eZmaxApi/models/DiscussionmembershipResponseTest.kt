...
import eZmaxApi.models.DiscussionmembershipResponse

class DiscussionmembershipResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of DiscussionmembershipResponse
        //val modelInstance = DiscussionmembershipResponse()
        ...
        // to test the property `sDiscussionmembershipDescription` - The Description containing the detail of who the Discussionmembership refers to
        should("test sDiscussionmembershipDescription") {
            // uncomment below to test the property
            //modelInstance.sDiscussionmembershipDescription shouldBe ("TODO")
        }
