...
class BrandingGetObjectV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of BrandingGetObjectV2Response
        //val modelInstance = BrandingGetObjectV2Response()
