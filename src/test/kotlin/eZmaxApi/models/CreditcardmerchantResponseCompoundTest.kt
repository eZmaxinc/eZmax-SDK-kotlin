...
class CreditcardmerchantResponseCompoundTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreditcardmerchantResponseCompound
        //val modelInstance = CreditcardmerchantResponseCompound()
