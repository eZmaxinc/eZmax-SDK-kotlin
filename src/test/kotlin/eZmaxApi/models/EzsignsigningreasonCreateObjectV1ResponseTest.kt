...
class EzsignsigningreasonCreateObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignsigningreasonCreateObjectV1Response
        //val modelInstance = EzsignsigningreasonCreateObjectV1Response()
