...
import eZmaxApi.models.CreditcardmerchantRequest

class CreditcardmerchantRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreditcardmerchantRequest
        //val modelInstance = CreditcardmerchantRequest()
        ...
        // to test the property `sCreditcardmerchantApitoken` - The apitoken of the Creditcardmerchant
        should("test sCreditcardmerchantApitoken") {
            // uncomment below to test the property
            //modelInstance.sCreditcardmerchantApitoken shouldBe ("TODO")
        }
