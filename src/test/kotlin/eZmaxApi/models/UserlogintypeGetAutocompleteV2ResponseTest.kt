...
class UserlogintypeGetAutocompleteV2ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of UserlogintypeGetAutocompleteV2Response
        //val modelInstance = UserlogintypeGetAutocompleteV2Response()
