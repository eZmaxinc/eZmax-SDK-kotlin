...
class CreditcardmerchantListElementTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CreditcardmerchantListElement
        //val modelInstance = CreditcardmerchantListElement()
