...
class EzsignfolderGetListV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of EzsignfolderGetListV1Response
        //val modelInstance = EzsignfolderGetListV1Response()
