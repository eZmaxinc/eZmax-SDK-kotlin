...
class InscriptionGetCommunicationListV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of InscriptionGetCommunicationListV1Response
        //val modelInstance = InscriptionGetCommunicationListV1Response()
