...
class PermissionCreateObjectV1ResponseTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of PermissionCreateObjectV1Response
        //val modelInstance = PermissionCreateObjectV1Response()
