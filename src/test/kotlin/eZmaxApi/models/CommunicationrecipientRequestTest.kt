...
class CommunicationrecipientRequestTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of CommunicationrecipientRequest
        //val modelInstance = CommunicationrecipientRequest()
