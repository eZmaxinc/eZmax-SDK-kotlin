...
class ObjectInvoiceApiTest : ShouldSpec() {
    init {
        ...
        // to test invoiceGetCommunicationCountV1
        should("test invoiceGetCommunicationCountV1") {
            // uncomment below to test invoiceGetCommunicationCountV1
            //val pkiInvoiceID : kotlin.Int = 56 // kotlin.Int | 
        ...
        // to test invoiceGetCommunicationrecipientsV1
        should("test invoiceGetCommunicationrecipientsV1") {
            // uncomment below to test invoiceGetCommunicationrecipientsV1
            //val pkiInvoiceID : kotlin.Int = 56 // kotlin.Int | 
            //val result : InvoiceGetCommunicationrecipientsV1Response = apiInstance.invoiceGetCommunicationrecipientsV1(pkiInvoiceID)
            //result shouldBe ("TODO")
        }

        // to test invoiceGetCommunicationsendersV1
        should("test invoiceGetCommunicationsendersV1") {
            // uncomment below to test invoiceGetCommunicationsendersV1
            //val pkiInvoiceID : kotlin.Int = 56 // kotlin.Int | 
