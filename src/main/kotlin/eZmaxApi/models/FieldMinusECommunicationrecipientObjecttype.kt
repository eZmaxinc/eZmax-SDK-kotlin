...
enum class FieldMinusECommunicationrecipientObjecttype(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is FieldMinusECommunicationrecipientObjecttype) "$data" else null

        /**
         * Returns a valid [FieldMinusECommunicationrecipientObjecttype] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): FieldMinusECommunicationrecipientObjecttype? = data?.let {
