...
data class EzsigntemplatedocumentMinusGetWordsPositionsMinusV1MinusRequest (
    ...
    @Json(name = "eGet")
    val eGet: EzsigntemplatedocumentMinusGetWordsPositionsMinusV1MinusRequest.EGet,
