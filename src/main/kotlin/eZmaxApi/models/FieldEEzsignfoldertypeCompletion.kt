 ...
 *
 * Values: PerEzsigndocument,PerEzsignfolder,PerEzsignfolderStepSync
 */

@JsonClass(generateAdapter = false)
enum class FieldEEzsignfoldertypeCompletion(val value: kotlin.String) {

    @Json(name = "PerEzsigndocument")
    PerEzsigndocument("PerEzsigndocument"),

    @Json(name = "PerEzsignfolder")
    PerEzsignfolder("PerEzsignfolder"),

    @Json(name = "PerEzsignfolderStepSync")
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is FieldEEzsignfoldertypeCompletion) "$data" else null

        /**
         * Returns a valid [FieldEEzsignfoldertypeCompletion] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): FieldEEzsignfoldertypeCompletion? = data?.let {
