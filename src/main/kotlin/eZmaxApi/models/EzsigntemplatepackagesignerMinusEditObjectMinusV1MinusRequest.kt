...
data class EzsigntemplatepackagesignerMinusEditObjectMinusV1MinusRequest (

    @Json(name = "objEzsigntemplatepackagesigner")
    val objEzsigntemplatepackagesigner: EzsigntemplatepackagesignerMinusRequestCompound
