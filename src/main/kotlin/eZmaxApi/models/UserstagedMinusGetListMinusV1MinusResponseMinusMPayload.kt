...
import eZmaxApi.models.UserstagedMinusListElement
...
data class UserstagedMinusGetListMinusV1MinusResponseMinusMPayload (

    @Json(name = "a_objUserstaged")
    val aObjUserstaged: kotlin.collections.List<UserstagedMinusListElement>,
