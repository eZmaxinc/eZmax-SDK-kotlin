...
data class UserMinusRequestCompound (
    ...
    @Json(name = "objEmail")
    val objEmail: EmailMinusRequestCompound,
    ...
    val objPhoneHome: PhoneMinusRequestCompound? = null,

    @Json(name = "objPhoneSMS")
    val objPhoneSMS: PhoneMinusRequestCompound? = null,
