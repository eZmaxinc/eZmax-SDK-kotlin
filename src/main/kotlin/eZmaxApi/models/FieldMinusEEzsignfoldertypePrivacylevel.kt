...
enum class FieldMinusEEzsignfoldertypePrivacylevel(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is FieldMinusEEzsignfoldertypePrivacylevel) "$data" else null

        /**
         * Returns a valid [FieldMinusEEzsignfoldertypePrivacylevel] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): FieldMinusEEzsignfoldertypePrivacylevel? = data?.let {
