...
data class WebsocketMinusRequestServerMinusGetWebsocketIDMinusV1 (

    /* The Type of message */
    @Json(name = "eWebsocketMessagetype")
    val eWebsocketMessagetype: WebsocketMinusRequestServerMinusGetWebsocketIDMinusV1.EWebsocketMessagetype
