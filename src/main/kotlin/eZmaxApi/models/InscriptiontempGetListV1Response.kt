...
import eZmaxApi.models.InscriptiontempGetListV1ResponseMPayload
...
data class InscriptiontempGetListV1Response (

    @Json(name = "objDebugPayload")
    val objDebugPayload: CommonResponseObjDebugPayloadGetList,

    @Json(name = "mPayload")
    val mPayload: InscriptiontempGetListV1ResponseMPayload,
