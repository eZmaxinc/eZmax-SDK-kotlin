...
enum class FieldMinusEPhoneType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is FieldMinusEPhoneType) "$data" else null

        /**
         * Returns a valid [FieldMinusEPhoneType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): FieldMinusEPhoneType? = data?.let {
