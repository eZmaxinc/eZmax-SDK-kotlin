...
enum class FieldEPhoneType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is FieldEPhoneType) "$data" else null

        /**
         * Returns a valid [FieldEPhoneType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): FieldEPhoneType? = data?.let {
