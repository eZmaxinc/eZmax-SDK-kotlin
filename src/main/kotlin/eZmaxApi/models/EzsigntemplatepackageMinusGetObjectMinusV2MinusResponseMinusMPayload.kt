...
data class EzsigntemplatepackageMinusGetObjectMinusV2MinusResponseMinusMPayload (

    @Json(name = "objEzsigntemplatepackage")
    val objEzsigntemplatepackage: EzsigntemplatepackageMinusResponseCompound
