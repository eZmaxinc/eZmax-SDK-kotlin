...
import eZmaxApi.models.BuyercontractGetListV1ResponseMPayload
...
data class BuyercontractGetListV1Response (

    @Json(name = "objDebugPayload")
    val objDebugPayload: CommonResponseObjDebugPayloadGetList,

    @Json(name = "mPayload")
    val mPayload: BuyercontractGetListV1ResponseMPayload,
