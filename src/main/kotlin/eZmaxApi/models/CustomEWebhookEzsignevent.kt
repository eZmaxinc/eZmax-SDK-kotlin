 ...
 *
 * Values: DocumentCompleted,DocumentFormCompleted,DocumentUnsent,EzsignsignerAcceptclause,EzsignsignerConnect,FolderCompleted,FolderDisposed,FolderSent,FolderUnsent
 */

@JsonClass(generateAdapter = false)
enum class CustomEWebhookEzsignevent(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is CustomEWebhookEzsignevent) "$data" else null

        /**
         * Returns a valid [CustomEWebhookEzsignevent] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): CustomEWebhookEzsignevent? = data?.let {
