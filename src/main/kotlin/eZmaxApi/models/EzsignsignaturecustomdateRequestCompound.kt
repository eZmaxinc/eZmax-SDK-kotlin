 ...
 * @param iEzsignsignaturecustomdateOffsetx The X coordinate (Horizontal) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 2 inches from the left of the signature, you would use \"200\" for the X coordinate.
 * @param iEzsignsignaturecustomdateOffsety The Y coordinate (Vertical) where to put the Ezsignsignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsignsignaturecustomdate block 3 inches from the top of the signature, you would use \"300\" for the Y coordinate.
 */


data class EzsignsignaturecustomdateRequestCompound (
    ...
    val iEzsignsignaturecustomdateX: kotlin.Int? = null,
    ...
    val iEzsignsignaturecustomdateY: kotlin.Int? = null,
    ...
    @Json(name = "iEzsignsignaturecustomdateOffsetx")
    val iEzsignsignaturecustomdateOffsetx: kotlin.Int? = null,
