...
enum class FieldESessionhistoryEndby(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is FieldESessionhistoryEndby) "$data" else null

        /**
         * Returns a valid [FieldESessionhistoryEndby] for [data], null otherwise.
         */
