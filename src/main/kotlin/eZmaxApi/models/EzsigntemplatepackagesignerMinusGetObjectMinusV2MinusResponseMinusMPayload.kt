...
data class EzsigntemplatepackagesignerMinusGetObjectMinusV2MinusResponseMinusMPayload (

    @Json(name = "objEzsigntemplatepackagesigner")
    val objEzsigntemplatepackagesigner: EzsigntemplatepackagesignerMinusResponseCompound
