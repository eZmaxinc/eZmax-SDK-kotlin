...
enum class FieldEEzsigndocumentlogType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is FieldEEzsigndocumentlogType) "$data" else null

        /**
         * Returns a valid [FieldEEzsigndocumentlogType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): FieldEEzsigndocumentlogType? = data?.let {
