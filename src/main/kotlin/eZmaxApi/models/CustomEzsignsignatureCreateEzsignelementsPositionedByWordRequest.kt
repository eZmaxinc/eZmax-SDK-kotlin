...
data class CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest (
    ...
    override val pkiEzsignsignatureID: kotlin.Int? = null,
    ...
    override val bEzsignsignatureCustomdate: kotlin.Boolean? = null,

    /* An array of custom date blocks that will be filled at the time of signature.  Can only be used if bEzsignsignatureCustomdate is true.  Use an empty array if you don't want to have a date at all. */
    @Json(name = "a_objEzsignsignaturecustomdate")
    override val aObjEzsignsignaturecustomdate: kotlin.collections.List<EzsignsignaturecustomdateRequest>? = null,

    @Json(name = "a_objEzsignelementdependency")
    override val aObjEzsignelementdependency: kotlin.collections.List<EzsignelementdependencyRequest>? = null
