 ...
 * @param iEzsignfolder The total number of Ezsignfolders using the Ezsigntemplatepublic
 * @param iEzsigndocument The total number of Ezsigndocuments using the Ezsigntemplatepublic
...
data class EzsigntemplatepublicListElement (
