...
class ObjectPeriodApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun periodGetAutocompleteV1(sSelector: SSelector_periodGetAutocompleteV1, eFilterActive: EFilterActive_periodGetAutocompleteV1? = Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : CommonMinusGetAutocompleteMinusV1MinusResponse {
    ...
    fun periodGetAutocompleteV1RequestConfig(sSelector: SSelector_periodGetAutocompleteV1, eFilterActive: EFilterActive_periodGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/period/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", sSelector.value.toString()),
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun periodGetAutocompleteV2(sSelector: SSelector_periodGetAutocompleteV2, eFilterActive: EFilterActive_periodGetAutocompleteV2? = Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : PeriodMinusGetAutocompleteMinusV2MinusResponse {
    ...
    fun periodGetAutocompleteV2RequestConfig(sSelector: SSelector_periodGetAutocompleteV2, eFilterActive: EFilterActive_periodGetAutocompleteV2?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/2/object/period/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", sSelector.value.toString()),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
