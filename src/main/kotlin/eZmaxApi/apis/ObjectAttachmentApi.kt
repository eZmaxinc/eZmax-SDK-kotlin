...
import eZmaxApi.models.AttachmentDownloadV1Response
...
class ObjectAttachmentApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun attachmentDownloadV1(pkiAttachmentID: kotlin.Int) : AttachmentDownloadV1Response {
        val localVarResponse = attachmentDownloadV1WithHttpInfo(pkiAttachmentID = pkiAttachmentID)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as AttachmentDownloadV1Response
    ...
    fun attachmentDownloadV1WithHttpInfo(pkiAttachmentID: kotlin.Int) : ApiResponse<AttachmentDownloadV1Response?> {
        val localVariableConfig = attachmentDownloadV1RequestConfig(pkiAttachmentID = pkiAttachmentID)

        return request<Unit, AttachmentDownloadV1Response>(
            localVariableConfig
        )
    }
