...
class ModuleAuthenticateApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun authenticateAuthenticateV2(eSessionType: kotlin.String, authenticateMinusAuthenticateMinusV2MinusRequest: AuthenticateMinusAuthenticateMinusV2MinusRequest) : AuthenticateMinusAuthenticateMinusV2MinusResponse {
        ...
        val localVarResponse = request<AuthenticateMinusAuthenticateMinusV2MinusResponse>(
            localVariableConfig
        )
    ...
    */
    fun authenticateAuthenticateV2RequestConfig(eSessionType: kotlin.String, authenticateMinusAuthenticateMinusV2MinusRequest: AuthenticateMinusAuthenticateMinusV2MinusRequest) : RequestConfig {
        val localVariableBody: kotlin.Any? = authenticateMinusAuthenticateMinusV2MinusRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        
        val localVariableConfig = RequestConfig(
            method = RequestMethod.POST,
            path = "/2/module/authenticate/authenticate/ezsignuser/{eSessionType}".replace("{"+"eSessionType"+"}", "$eSessionType"),
