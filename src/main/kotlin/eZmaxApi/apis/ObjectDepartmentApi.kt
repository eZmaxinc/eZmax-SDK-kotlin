...
class ObjectDepartmentApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun departmentGetAutocompleteV1(sSelector: SSelector_departmentGetAutocompleteV1, eFilterActive: EFilterActive_departmentGetAutocompleteV1? = EFilterActive_departmentGetAutocompleteV1.Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : CommonMinusGetAutocompleteMinusV1MinusResponse {
    ...
    fun departmentGetAutocompleteV1RequestConfig(sSelector: SSelector_departmentGetAutocompleteV1, eFilterActive: EFilterActive_departmentGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/department/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
    ...
    fun departmentGetMembersV1RequestConfig(pkiDepartmentID: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/1/object/department/{pkiDepartmentID}/getMembers".replace("{"+"pkiDepartmentID"+"}", encodeURIComponent(pkiDepartmentID.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
