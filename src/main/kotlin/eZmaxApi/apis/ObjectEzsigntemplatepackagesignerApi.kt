...
class ObjectEzsigntemplatepackagesignerApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    fun ezsigntemplatepackagesignerDeleteObjectV1RequestConfig(pkiEzsigntemplatepackagesignerID: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}".replace("{"+"pkiEzsigntemplatepackagesignerID"+"}", "$pkiEzsigntemplatepackagesignerID"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
