...
open class ObjectWebhookApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
     ...
     */
     enum class EOrderByWebhookGetListV1(val value: kotlin.String) {
         ...
         @Json(name = "eWebhookRealestateevent_ASC") eWebhookRealestateevent_ASC("eWebhookRealestateevent_ASC"),
         @Json(name = "eWebhookRealestateevent_DESC") eWebhookRealestateevent_DESC("eWebhookRealestateevent_DESC"),
