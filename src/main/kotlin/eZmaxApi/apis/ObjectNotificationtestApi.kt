...
class ObjectNotificationtestApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    fun notificationtestGetElementsV1RequestConfig(pkiNotificationtestID: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/notificationtest/{pkiNotificationtestID}/getElements".replace("{"+"pkiNotificationtestID"+"}", "$pkiNotificationtestID"),
