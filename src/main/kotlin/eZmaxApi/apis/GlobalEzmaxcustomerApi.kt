...
open class GlobalEzmaxcustomerApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    /**
     * To obtain the request config of the operation globalEzmaxcustomerGetConfigurationV1
     *
     * @param pksEzmaxcustomerCode 
     * @return RequestConfig
     */
    fun globalEzmaxcustomerGetConfigurationV1RequestConfig(pksEzmaxcustomerCode: kotlin.String) : RequestConfig<Unit> {
