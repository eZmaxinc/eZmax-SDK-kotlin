...
open class ObjectEzmaxproductApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun ezmaxproductGetAutocompleteV2RequestConfig(sSelector: SSelectorEzmaxproductGetAutocompleteV2, eFilterActive: EFilterActiveEzmaxproductGetAutocompleteV2?, sQuery: kotlin.String?, acceptLanguage: HeaderAcceptLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/2/object/ezmaxproduct/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
