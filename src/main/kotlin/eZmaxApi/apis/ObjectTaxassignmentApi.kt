...
class ObjectTaxassignmentApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun taxassignmentGetAutocompleteV1(sSelector: SSelector_taxassignmentGetAutocompleteV1, eFilterActive: EFilterActive_taxassignmentGetAutocompleteV1? = EFilterActive_taxassignmentGetAutocompleteV1.Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : CommonMinusGetAutocompleteMinusV1MinusResponse {
    ...
    fun taxassignmentGetAutocompleteV1RequestConfig(sSelector: SSelector_taxassignmentGetAutocompleteV1, eFilterActive: EFilterActive_taxassignmentGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/taxassignment/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
    ...
    fun taxassignmentGetAutocompleteV2RequestConfig(sSelector: SSelector_taxassignmentGetAutocompleteV2, eFilterActive: EFilterActive_taxassignmentGetAutocompleteV2?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/2/object/taxassignment/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
