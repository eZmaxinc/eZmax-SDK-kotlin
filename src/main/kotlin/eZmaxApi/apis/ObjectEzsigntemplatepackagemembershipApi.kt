...
class ObjectEzsigntemplatepackagemembershipApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    fun ezsigntemplatepackagemembershipDeleteObjectV1RequestConfig(pkiEzsigntemplatepackagemembershipID: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}".replace("{"+"pkiEzsigntemplatepackagemembershipID"+"}", "$pkiEzsigntemplatepackagemembershipID"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
