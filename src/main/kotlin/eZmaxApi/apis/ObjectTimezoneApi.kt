...
class ObjectTimezoneApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun timezoneGetAutocompleteV1(sSelector: SSelector_timezoneGetAutocompleteV1, eFilterActive: EFilterActive_timezoneGetAutocompleteV1? = EFilterActive_timezoneGetAutocompleteV1.Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : CommonMinusGetAutocompleteMinusV1MinusResponse {
    ...
    fun timezoneGetAutocompleteV1RequestConfig(sSelector: SSelector_timezoneGetAutocompleteV1, eFilterActive: EFilterActive_timezoneGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/timezone/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
