...
class ObjectTimezoneApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
     ...
     */
     enum class SSelector_timezoneGetAutocompleteV1(val value: kotlin.String) {
     ...
     */
     enum class EFilterActive_timezoneGetAutocompleteV1(val value: kotlin.String) {
         @Json(name = "All") All("All"),
         @Json(name = "Active") Active("Active"),
    ...
    fun timezoneGetAutocompleteV1(sSelector: SSelector_timezoneGetAutocompleteV1, eFilterActive: EFilterActive_timezoneGetAutocompleteV1? = Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : CommonMinusGetAutocompleteMinusV1MinusResponse {
        @Suppress("DEPRECATION")
        val localVarResponse = timezoneGetAutocompleteV1WithHttpInfo(sSelector = sSelector, eFilterActive = eFilterActive, sQuery = sQuery, acceptLanguage = acceptLanguage)
    ...
    @Deprecated(message = "This operation is deprecated.")
    fun timezoneGetAutocompleteV1WithHttpInfo(sSelector: SSelector_timezoneGetAutocompleteV1, eFilterActive: EFilterActive_timezoneGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : ApiResponse<CommonMinusGetAutocompleteMinusV1MinusResponse?> {
        @Suppress("DEPRECATION")
        val localVariableConfig = timezoneGetAutocompleteV1RequestConfig(sSelector = sSelector, eFilterActive = eFilterActive, sQuery = sQuery, acceptLanguage = acceptLanguage)
    ...
    /**
     * To obtain the request config of the operation timezoneGetAutocompleteV1
     *
     * @param sSelector The type of Timezones to return
     * @param eFilterActive Specify which results we want to display. (optional, default to Active)
     * @param sQuery Allow to filter the returned results (optional)
     ...
     */
    @Deprecated(message = "This operation is deprecated.")
    fun timezoneGetAutocompleteV1RequestConfig(sSelector: SSelector_timezoneGetAutocompleteV1, eFilterActive: EFilterActive_timezoneGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/timezone/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", sSelector.value.toString()),
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun timezoneGetAutocompleteV2(sSelector: SSelector_timezoneGetAutocompleteV2, eFilterActive: EFilterActive_timezoneGetAutocompleteV2? = Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : TimezoneMinusGetAutocompleteMinusV2MinusResponse {
    ...
    fun timezoneGetAutocompleteV2RequestConfig(sSelector: SSelector_timezoneGetAutocompleteV2, eFilterActive: EFilterActive_timezoneGetAutocompleteV2?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/2/object/timezone/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", sSelector.value.toString()),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
