...
class ObjectSecretquestionApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun secretquestionGetAutocompleteV1RequestConfig(sSelector: SSelector_secretquestionGetAutocompleteV1, eFilterActive: EFilterActive_secretquestionGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/secretquestion/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun secretquestionGetAutocompleteV2(sSelector: SSelector_secretquestionGetAutocompleteV2, eFilterActive: EFilterActive_secretquestionGetAutocompleteV2? = EFilterActive_secretquestionGetAutocompleteV2.Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : SecretquestionMinusGetAutocompleteMinusV2MinusResponse {
