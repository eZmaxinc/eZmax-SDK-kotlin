...
open class ObjectCompanyApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun companyGetAutocompleteV2RequestConfig(sSelector: SSelectorCompanyGetAutocompleteV2, eFilterActive: EFilterActiveCompanyGetAutocompleteV2?, sQuery: kotlin.String?, acceptLanguage: HeaderAcceptLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/2/object/company/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
