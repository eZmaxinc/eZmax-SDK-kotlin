...
class ObjectFranchiseofficeApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun franchiseofficeGetAutocompleteV1(sSelector: SSelector_franchiseofficeGetAutocompleteV1, eFilterActive: EFilterActive_franchiseofficeGetAutocompleteV1? = EFilterActive_franchiseofficeGetAutocompleteV1.Active, sQuery: kotlin.String? = null, acceptLanguage: HeaderMinusAcceptMinusLanguage? = null) : CommonMinusGetAutocompleteMinusV1MinusResponse {
    ...
    fun franchiseofficeGetAutocompleteV1RequestConfig(sSelector: SSelector_franchiseofficeGetAutocompleteV1, eFilterActive: EFilterActive_franchiseofficeGetAutocompleteV1?, sQuery: kotlin.String?, acceptLanguage: HeaderMinusAcceptMinusLanguage?) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/franchiseoffice/getAutocomplete/{sSelector}".replace("{"+"sSelector"+"}", encodeURIComponent(sSelector.value.toString())),
