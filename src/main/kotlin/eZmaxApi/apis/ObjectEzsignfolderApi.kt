...
import eZmaxApi.models.EzsignfolderGetEzsignfoldersignerassociationsV2Response
...
open class ObjectEzsignfolderApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun ezsignfolderCreateObjectV3(ezsignfolderCreateObjectV3Request: EzsignfolderCreateObjectV3Request) : EzsignfolderCreateObjectV3Response {
        val localVarResponse = ezsignfolderCreateObjectV3WithHttpInfo(ezsignfolderCreateObjectV3Request = ezsignfolderCreateObjectV3Request)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EzsignfolderCreateObjectV3Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun ezsignfolderCreateObjectV3WithHttpInfo(ezsignfolderCreateObjectV3Request: EzsignfolderCreateObjectV3Request) : ApiResponse<EzsignfolderCreateObjectV3Response?> {
        val localVariableConfig = ezsignfolderCreateObjectV3RequestConfig(ezsignfolderCreateObjectV3Request = ezsignfolderCreateObjectV3Request)

        return request<EzsignfolderCreateObjectV3Request, EzsignfolderCreateObjectV3Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation ezsignfolderCreateObjectV3
     *
     * @param ezsignfolderCreateObjectV3Request 
     * @return RequestConfig
     */
    fun ezsignfolderCreateObjectV3RequestConfig(ezsignfolderCreateObjectV3Request: EzsignfolderCreateObjectV3Request) : RequestConfig<EzsignfolderCreateObjectV3Request> {
        val localVariableBody = ezsignfolderCreateObjectV3Request
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
    ...
    /**
     * To obtain the request config of the operation ezsignfolderEditObjectV3
     *
     * @param pkiEzsignfolderID 
     * @param ezsignfolderEditObjectV3Request 
     * @return RequestConfig
     */
    fun ezsignfolderEditObjectV3RequestConfig(pkiEzsignfolderID: kotlin.Int, ezsignfolderEditObjectV3Request: EzsignfolderEditObjectV3Request) : RequestConfig<EzsignfolderEditObjectV3Request> {
        val localVariableBody = ezsignfolderEditObjectV3Request
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            ...
            path = "/3/object/ezsignfolder/{pkiEzsignfolderID}".replace("{"+"pkiEzsignfolderID"+"}", encodeURIComponent(pkiEzsignfolderID.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    /**
     * GET /2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements
     * Retrieve actionable elements for the Ezsignfolder
    ...
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun ezsignfolderGetActionableElementsV2(pkiEzsignfolderID: kotlin.Int) : EzsignfolderGetActionableElementsV2Response {
        @Suppress("DEPRECATION")
        val localVarResponse = ezsignfolderGetActionableElementsV2WithHttpInfo(pkiEzsignfolderID = pkiEzsignfolderID)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EzsignfolderGetActionableElementsV2Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Throws(IllegalStateException::class, IOException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun ezsignfolderGetActionableElementsV2WithHttpInfo(pkiEzsignfolderID: kotlin.Int) : ApiResponse<EzsignfolderGetActionableElementsV2Response?> {
        @Suppress("DEPRECATION")
        val localVariableConfig = ezsignfolderGetActionableElementsV2RequestConfig(pkiEzsignfolderID = pkiEzsignfolderID)

        return request<Unit, EzsignfolderGetActionableElementsV2Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation ezsignfolderGetActionableElementsV2
     *
     * @param pkiEzsignfolderID 
     * @return RequestConfig
     */
    @Deprecated(message = "This operation is deprecated.")
    fun ezsignfolderGetActionableElementsV2RequestConfig(pkiEzsignfolderID: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements".replace("{"+"pkiEzsignfolderID"+"}", encodeURIComponent(pkiEzsignfolderID.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    /**
     * GET /3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements
     * Retrieve actionable elements for the Ezsignfolder
     * Return the Ezsignsignatures that can be signed and Ezsignformfieldgroups that can be filled by the current user at the current step in the process
     * @param pkiEzsignfolderID 
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun ezsignfolderGetActionableElementsV3(pkiEzsignfolderID: kotlin.Int) : EzsignfolderGetActionableElementsV3Response {
        val localVarResponse = ezsignfolderGetActionableElementsV3WithHttpInfo(pkiEzsignfolderID = pkiEzsignfolderID)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EzsignfolderGetActionableElementsV3Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun ezsignfolderGetActionableElementsV3WithHttpInfo(pkiEzsignfolderID: kotlin.Int) : ApiResponse<EzsignfolderGetActionableElementsV3Response?> {
        val localVariableConfig = ezsignfolderGetActionableElementsV3RequestConfig(pkiEzsignfolderID = pkiEzsignfolderID)

        return request<Unit, EzsignfolderGetActionableElementsV3Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation ezsignfolderGetActionableElementsV3
     *
     * @param pkiEzsignfolderID 
     * @return RequestConfig
     */
    fun ezsignfolderGetActionableElementsV3RequestConfig(pkiEzsignfolderID: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements".replace("{"+"pkiEzsignfolderID"+"}", encodeURIComponent(pkiEzsignfolderID.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    /**
     * GET /2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsigndocuments
     * Retrieve an existing Ezsignfolder&#39;s Ezsigndocuments
     * 
     * @param pkiEzsignfolderID 
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun ezsignfolderGetEzsigndocumentsV2(pkiEzsignfolderID: kotlin.Int) : EzsignfolderGetEzsigndocumentsV2Response {
        val localVarResponse = ezsignfolderGetEzsigndocumentsV2WithHttpInfo(pkiEzsignfolderID = pkiEzsignfolderID)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EzsignfolderGetEzsigndocumentsV2Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun ezsignfolderGetEzsigndocumentsV2WithHttpInfo(pkiEzsignfolderID: kotlin.Int) : ApiResponse<EzsignfolderGetEzsigndocumentsV2Response?> {
        val localVariableConfig = ezsignfolderGetEzsigndocumentsV2RequestConfig(pkiEzsignfolderID = pkiEzsignfolderID)

        return request<Unit, EzsignfolderGetEzsigndocumentsV2Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation ezsignfolderGetEzsigndocumentsV2
     *
     * @param pkiEzsignfolderID 
     * @return RequestConfig
     */
    fun ezsignfolderGetEzsigndocumentsV2RequestConfig(pkiEzsignfolderID: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsigndocuments".replace("{"+"pkiEzsignfolderID"+"}", encodeURIComponent(pkiEzsignfolderID.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
    ...
    /**
     * GET /2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations
     * Retrieve an existing Ezsignfolder&#39;s Ezsignfoldersignerassociations
     * 
     * @param pkiEzsignfolderID 
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun ezsignfolderGetEzsignfoldersignerassociationsV2(pkiEzsignfolderID: kotlin.Int) : EzsignfolderGetEzsignfoldersignerassociationsV2Response {
        val localVarResponse = ezsignfolderGetEzsignfoldersignerassociationsV2WithHttpInfo(pkiEzsignfolderID = pkiEzsignfolderID)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EzsignfolderGetEzsignfoldersignerassociationsV2Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun ezsignfolderGetEzsignfoldersignerassociationsV2WithHttpInfo(pkiEzsignfolderID: kotlin.Int) : ApiResponse<EzsignfolderGetEzsignfoldersignerassociationsV2Response?> {
        val localVariableConfig = ezsignfolderGetEzsignfoldersignerassociationsV2RequestConfig(pkiEzsignfolderID = pkiEzsignfolderID)

        return request<Unit, EzsignfolderGetEzsignfoldersignerassociationsV2Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation ezsignfolderGetEzsignfoldersignerassociationsV2
     *
     * @param pkiEzsignfolderID 
     * @return RequestConfig
     */
    fun ezsignfolderGetEzsignfoldersignerassociationsV2RequestConfig(pkiEzsignfolderID: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations".replace("{"+"pkiEzsignfolderID"+"}", encodeURIComponent(pkiEzsignfolderID.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
     ...
     */
     enum class EOrderByEzsignfolderGetListV1(val value: kotlin.String) {
         ...
         @Json(name = "eEzsignfolderCompletion_ASC") eEzsignfolderCompletion_ASC("eEzsignfolderCompletion_ASC"),
         @Json(name = "eEzsignfolderCompletion_DESC") eEzsignfolderCompletion_DESC("eEzsignfolderCompletion_DESC"),
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun ezsignfolderGetObjectV3(pkiEzsignfolderID: kotlin.Int) : EzsignfolderGetObjectV3Response {
        val localVarResponse = ezsignfolderGetObjectV3WithHttpInfo(pkiEzsignfolderID = pkiEzsignfolderID)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EzsignfolderGetObjectV3Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun ezsignfolderGetObjectV3WithHttpInfo(pkiEzsignfolderID: kotlin.Int) : ApiResponse<EzsignfolderGetObjectV3Response?> {
        val localVariableConfig = ezsignfolderGetObjectV3RequestConfig(pkiEzsignfolderID = pkiEzsignfolderID)

        return request<Unit, EzsignfolderGetObjectV3Response>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation ezsignfolderGetObjectV3
     *
     * @param pkiEzsignfolderID 
     * @return RequestConfig
     */
    fun ezsignfolderGetObjectV3RequestConfig(pkiEzsignfolderID: kotlin.Int) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
    ...
    /**
     * POST /2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage
     * Import an Ezsigntemplatepackage in the Ezsignfolder
    ...
    fun ezsignfolderImportEzsigntemplatepackageV2(pkiEzsignfolderID: kotlin.Int, ezsignfolderImportEzsigntemplatepackageV2Request: EzsignfolderImportEzsigntemplatepackageV2Request) : EzsignfolderImportEzsigntemplatepackageV2Response {
        ...
        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EzsignfolderImportEzsigntemplatepackageV2Response
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    /**
     * To obtain the request config of the operation ezsignfolderImportEzsigntemplatepackageV2
     *
     * @param pkiEzsignfolderID 
     * @param ezsignfolderImportEzsigntemplatepackageV2Request 
     * @return RequestConfig
    ...
    /**
     * To obtain the request config of the operation ezsignfolderReorderV2
     *
     * @param pkiEzsignfolderID 
     * @param ezsignfolderReorderV2Request 
     * @return RequestConfig
     */
    fun ezsignfolderReorderV2RequestConfig(pkiEzsignfolderID: kotlin.Int, ezsignfolderReorderV2Request: EzsignfolderReorderV2Request) : RequestConfig<EzsignfolderReorderV2Request> {
        val localVariableBody = ezsignfolderReorderV2Request
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
        ...
        return RequestConfig(
            method = RequestMethod.POST,
            path = "/2/object/ezsignfolder/{pkiEzsignfolderID}/reorder".replace("{"+"pkiEzsignfolderID"+"}", encodeURIComponent(pkiEzsignfolderID.toString())),
            query = localVariableQuery,
            headers = localVariableHeaders,
            requiresAuthentication = true,
            body = localVariableBody
