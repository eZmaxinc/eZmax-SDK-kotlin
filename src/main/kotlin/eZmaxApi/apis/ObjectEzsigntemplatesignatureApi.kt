...
class ObjectEzsigntemplatesignatureApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    fun ezsigntemplatesignatureDeleteObjectV1RequestConfig(pkiEzsigntemplatesignatureID: kotlin.Int) : RequestConfig<Unit> {
        ...
        return RequestConfig(
            ...
            path = "/1/object/ezsigntemplatesignature/{pkiEzsigntemplatesignatureID}".replace("{"+"pkiEzsigntemplatesignatureID"+"}", "$pkiEzsigntemplatesignatureID"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
