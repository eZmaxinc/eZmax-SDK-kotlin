...
import eZmaxinc/eZmax-SDK-kotlin.models.EzsignsignatureMinusEditObjectMinusV1MinusRequest
import eZmaxinc/eZmax-SDK-kotlin.models.EzsignsignatureMinusEditObjectMinusV1MinusResponse
...
class ObjectEzsignsignatureApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun ezsignsignatureDeleteObjectV1(pkiEzsignsignatureID: kotlin.Int) : EzsignsignatureMinusDeleteObjectMinusV1MinusResponse {
        ...
        val localVariableConfig = RequestConfig(
            ...
            "/1/object/ezsignsignature/{pkiEzsignsignatureID}".replace("{"+"pkiEzsignsignatureID"+"}", "$pkiEzsignsignatureID"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
    ...
    */
    ...
    fun ezsignsignatureEditObjectV1(pkiEzsignsignatureID: kotlin.Int, ezsignsignatureMinusEditObjectMinusV1MinusRequest: EzsignsignatureMinusEditObjectMinusV1MinusRequest) : EzsignsignatureMinusEditObjectMinusV1MinusResponse {
        val localVariableBody: kotlin.Any? = ezsignsignatureMinusEditObjectMinusV1MinusRequest
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.PUT,
        ...
        val localVarResponse = request<EzsignsignatureMinusEditObjectMinusV1MinusResponse>(
            localVariableConfig,
            localVariableBody
        )
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun ezsignsignatureGetObjectGetChildrenV1(pkiEzsignsignatureID: kotlin.Int) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/1/object/ezsignsignature/{pkiEzsignsignatureID}/getChildren".replace("{"+"pkiEzsignsignatureID"+"}", "$pkiEzsignsignatureID"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
