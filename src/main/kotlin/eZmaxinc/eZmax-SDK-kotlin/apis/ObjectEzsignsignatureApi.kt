...
class ObjectEzsignsignatureApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    * @return RequestConfig
    */
    fun ezsignsignatureEditObjectV1RequestConfig(pkiEzsignsignatureID: kotlin.Int, ezsignsignatureMinusEditObjectMinusV1MinusRequest: EzsignsignatureMinusEditObjectMinusV1MinusRequest) : RequestConfig {
